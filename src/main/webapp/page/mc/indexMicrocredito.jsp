...
<html>
    <head>
        <meta charset="utf-8" />
        <title>YES I Start Up - Sicilia - Home Page</title>
                        ...
                        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                                <div class="kt-subheader__main">
                                    ...
                                    <a class="kt-subheader__breadcrumbs-link">YES I Start Up - Sicilia</a>
                                </div>
                            </div>
                        </div>
                        <br>
                            ...
                            <div class="row">
                                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12" style="padding-right: 0px;">
                                    ...
                                    <div class="row flex col-lg-12"  style="margin-right: 0px; padding-right: 0px;">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12" style="padding-bottom: 1.5rem;">
                                            <a href="searchSA.jsp"><div class="one-half custom-redbox soggetti">Soggetti Attuatori da validare<br>
                                                    <label style="font-size: 3rem; font-weight: 800;"><%=contatori[3]%></label></div></a>
                                        </div>
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12" style="padding-bottom: 1.5rem;">
                                            <a href="searchSA.jsp"><div class="one-half custom-greenbox soggetti">Soggetto Attuatore Attivi<br>
