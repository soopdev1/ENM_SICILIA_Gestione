...
<html>
    <head>
        <meta charset="utf-8" />
        <title>YES I Start Up - Sicilia - Assegna Operatore ENM</title>
                            ...
                            <div class="kt-portlet kt-portlet--mobile">
                                ...
                                <div class="kt-portlet__body">
                                    ...
                                    <form method="POST" action="<%=request.getContextPath()%>/OperazioniMicro">
                                        ...
                                        <div class="row col-md-12">
                                            <div class="form-group col-md-6">
                                                <label class="kt-font-info kt-font-boldest">Attraverso quale principale canale è venuto a conoscenza del progetto YISU Sicilia?</label>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label class="kt-font-info kt-font-boldest">Per quale principale motivazione ha scelto di frequentare YISU-Sicilia?</label>
                                        ...
                                        <div class="row col-md-12" id="div_volontasi">
                                            <div class="form-group col-md-6">
                                                <label class="kt-font-info kt-font-boldest">Con quale Soggetto Attuatore vorrebbe realizzare il percorso?</label>
