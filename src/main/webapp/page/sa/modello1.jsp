                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="alert alert-info">
                                                    MODELLO 1 - La scheda d'iscrizione deve essere compilata in ogni sua parte, i campi contrassegnati con l'asterisco sono obbligatori. La scheda generata dal sistema informativo dovr&#224; essere firmata (con firma elettronica pdf) dall'allievo e caricata in piattaforma. 
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                                        ...
                                                        <div class="form-group form-group-sm row">
                                                            <div class="col-12">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <div class="alert alert-warning">
                                                                            É possibile caricare il Modello 1 firmato dall'allievo anche in un secondo momento. <br>
                                                                            In tal caso è utile ricordare che lo stesso allievo non sarà "Attivo" (e dunque non disponibile per partecipare ad eventuali Progetti Formativi) fin quando il Modello 1 non sarà caricato. 
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="form-group col-xl-6 col-lg-6">
                                                                        <label>Scaricare il modello con i dati inseriti per poi caricarlo firmato dall'allievo nel campo seguente.</label>
