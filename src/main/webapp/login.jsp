...
<html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>YES I Start Up - Sicilia</title>
                        ...
                        <div class="kt-login__container">
                            ...
                            <div class="kt-login__signin">
                                <div class="kt-login__head">
                                    ...
                                    <h3 class="kt-login__title kt-font-io" style="font-size:2rem"><b>YES I STARTUP - Regione Sicilia</b></h3>
                                    <%} else {%>
                                    <h3 class="kt-login__title kt-font-io" style="font-size:2rem"><b>YES I STARTUP - Regione Sicilia</b></h3>
                                    <%if (Utility.test) {%>
                                    <br>
                            ...
                            <div class="login__logo"> 
                                <center>
                                    <img src="assets/soop/img/l4-yis.png" alt="" height="54px"/>
